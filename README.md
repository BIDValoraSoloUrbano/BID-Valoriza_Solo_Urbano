...
Lembrete: A pasta com dados para a simulação de cálculo e a pasta com plugin estão contidos no arquivo ["BID_VALORIZA_DADOS.rar"](https://github.com/BIDValoraSoloUrbano/BID-Valoriza_Solo_Urbano/blob/master/BID_VALORIZA_DADOS.rar).
